...
btApp.controller('purchasedProductCtrl', function ($scope, $http) {
    $scope.title = "sdg,bndskjhdf lkj hk";
    $scope.data = objPurchasedProduct;
    $scope.parent = { data: '' };
    ...
    $scope.submitForm = function () {
        ...
        $http({
            url: '/Support/SavePurchasedDetails',
            method: 'POST',
            data: $scope.data,
...
$(document).ready(function () {
    $.btApplyCaptcha();
    $('#purchasedproductForm').formValidation({
        framework: 'bootstrap',
        icon: {
    ...
    objFormValidation = $('#purchasedproductForm').data('formValidation');
