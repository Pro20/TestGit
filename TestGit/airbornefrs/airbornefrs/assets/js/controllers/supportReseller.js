...
btApp.controller('ResellerCtrl', function ($scope, $http) {
    $scope.title = "sdg,bndskjhdf lkj hk";
    $scope.data = objContactReseller;
    $scope.parent = { data: '' };
    ...
    $scope.submitForm = function () {
        ...
        $http({
            url: '/Support/SaveResellerDetails',
            method: 'POST',
            data: $scope.data,
...
$(document).ready(function () {
    $.btApplyCaptcha();
    $('#BecomeaReseller').formValidation({
        framework: 'bootstrap',
        icon: {
    ...
    objFormValidation = $('#BecomeaReseller').data('formValidation');
